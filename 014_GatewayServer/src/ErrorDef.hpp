...
namespace DeprecatedLib
{
	...
	*/
	typedef enum enmErrorNO
	{
		...
		EEN_STATISTIC__INVALID_SECTION_NUM = 0x00070011, //!<非法的统计段个数
		EEN_STATISTIC__NEW_SECTION_FAILED = 0x00070012, //!<动态分配Section失败
		EEN_STATISTIC__SECTION_NUM_REACH_UPPER_LIMIT = 0x00070013, //!<Section个数达到上限
		EEN_STATISTIC__INVALID_SECTION_INDEX = 0x00070014, //!<非法的段索引
		EEN_STATISTIC__LOG_FILE_INIT_FAILED = 0x00070015, //!<统计打印配置初始化失败
		EEN_STATISTIC__ITEM_NUM_REACH_UPPER_LIMIT = 0x00070016, //!<统计项个数达到上限
